Management of Cypress data, including upload to and download from HDFS, has to be done from **dsciutil**. The dsciutil node is configured to have access to other file systems used with Palmetto:
- */home*
- */scratch1*
- */scratch2*
- etc.
